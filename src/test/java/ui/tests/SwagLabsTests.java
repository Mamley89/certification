...
public class SwagLabsTests {
    ...
    public void validAuth(LoginPage loginPage, MainPage mainPage) {
        ...
        mainPage.openMenu();
        mainPage.logoutButton.shouldBe(text(textToBe));
        step("Проверить, что есть кнопка \"Logout\"", () -> mainPage.logoutButton.shouldBe(text(textToBe)));
    }
    ...
    public void fullOrderCycle(String logins, LoginPage loginPage, MainPage mainPage, CartPage cartPage, CheckoutPage checkoutPage) {
        ...
        checkoutPage.fillingForm("Alex", "Taranov","345636");
