...
public class EmployeeContractTests {
    ...
    public void getEmployeesOfCompany(int companyId, DbHelper dbHelper
    ...
    public void getEmployeesOfCompanyWithInvalidId(
            OpenApiValidationFilter openApiValidationFilter
    ) {
    ...
    public void addNewEmployee(int companyID, ApiTestHelper apiHelper, String authToken
            , OpenApiValidationFilter openApiValidationFilter
    ) {
    ...
    public void addNewEmployeeWithAllData(int companyId, ApiTestHelper apiHelper, String authToken
            , OpenApiValidationFilter openApiValidationFilter
    ) {
    ...
    public void getEmployeeById(int companyId, DbHelper dbHelper
            , OpenApiValidationFilter openApiValidationFilter
    ) throws SQLException {
    ...
    public void updateEmployeeInfo(int companyId, DbHelper dbHelper, ApiTestHelper apiHelper, String authToken
            , OpenApiValidationFilter openApiValidationFilter
    ) throws SQLException {
    ...
    public void updateEmployeeInfoWithoutSchema(int companyId, DbHelper dbHelper, ApiTestHelper apiHelper, String authToken
            , OpenApiValidationFilter openApiValidationFilter
    ) throws SQLException {
        int employeeId = dbHelper.insertEmployeeToCompany(companyId);
    ...
    public void updateInvalidEmployeeInfo(ApiTestHelper apiHelper, String authToken
            , OpenApiValidationFilter openApiValidationFilter
    ) {
        UpdateEmployeeRequest newInfoForEmployee = apiHelper.createBodyForUpdate();
